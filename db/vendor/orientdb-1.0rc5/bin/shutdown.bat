...
call %JAVA% -client %JAVA_OPTS% -Dorientdb.config.file="%CONFIG_FILE%" -cp "%ORIENTDB_HOME%\lib\orientdb-server-1.0rc5.jar" com.orientechnologies.orient.server.OServerShutdownMain %CMD_LINE_ARGS%
